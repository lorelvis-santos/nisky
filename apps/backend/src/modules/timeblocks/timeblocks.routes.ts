...
router.get("/:id/exceptions", validateParams(idParamSchema), controller.listExceptions);
router.delete("/:id/exceptions/:exceptionId", validateParams(exceptionIdParamSchema), controller.deleteException);
