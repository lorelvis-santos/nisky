      ...
      <div className="grid max-w-5xl gap-section-gap lg:grid-cols-[minmax(0,24rem)_1fr]">
        <section className="border border-outline-variant bg-surface-container-lowest p-container-padding">
          ...
          <div className="mt-4 space-y-3">
            ...
            <label className="block"><span className="font-label-caps text-label-caps text-on-surface-variant">DETALLE (OPCIONAL)</span><textarea className="field mt-1 min-h-20 resize-y" onChange={(event) => setBody(event.target.value)} placeholder="Añade un poco de contexto" value={body} /></label>
