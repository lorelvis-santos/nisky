...
const FAQS: Array<{ question: string; answer: string }> = [
  ...
  },
  {
    ...
    answer:
      "Ve a Ajustes › Integraciones y elige tu universidad de la lista (ITLA, INTEC, PUCMM, UNAPEC, UNPHU, UCNE, UTECO u otra). Con tus credenciales o un token, Nisky conecta la plataforma de tu institución y trae tus tareas y entregas próximas.",
  },
  {
